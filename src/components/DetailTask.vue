<template>
    ...
    <div class="flex flex-wrap items-center" @click="showEditText()" @mouseover="editText(1)" @mouseleave="editText(2)">
        <div id="show-text" class="flex w-full">
            <div class="w-[95%] bg-[#f4f5f7] py-3" id="content-text">{{ props.detailTask.summary }}</div>
    ...
    <div class="flex flex-wrap items-center" @click="showEditDescription()" @mouseover="editDescription(1)"
        ...
        <div id="show-description" class="flex w-full">
            <div class="w-[95%] bg-[#f4f5f7] py-3" id="content-description">
                <div v-html="props.detailTask.text"></div>
            </div>
...
watch(() => props.detailTask, () => {
    ...
    contentDescription.value = props.detailTask.text;
...
const renderStatus = computed(() => {
    if (props.detailTask.status === 0) return 'Todo';
    else if (props.detailTask.status === 1) return 'Pending';
    else if (props.detailTask.status === 2) return 'Progress';
    else if (props.detailTask.status === 3) return 'In Testing';
    else return 'Done'
})
</script>
<style>
